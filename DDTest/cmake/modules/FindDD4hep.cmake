...
if (DD4hep_LIBRARIES) 
   ...
   #collecting all the DD4hep libraries
   file(GLOB DD4hep_LIBRARIES ${DD4hep_LIBRARIES} ${DD4hep_LIBRARY_DIR}/*.so)
   message(STATUS "Found DD4hep library in ${DD4hep_LIBRARY_DIR}")		
else()
